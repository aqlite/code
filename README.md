# This a gd zip just extract it and double click until you see a large amount of files in there then open any exe on the folder you can open GeometryDash.exe
